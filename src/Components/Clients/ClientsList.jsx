...
import axios from "../../Schemas/Api";
import DeleteUser from "../../Modals/InviteAgent/InviteAgentPop";
import ClientsPop from "../../Modals/ClientsPop/ClientsPop";
// import "./Users.css";
...
const ClientList = () => {
  ...
  return (
    ...
    <span className="Mian-Interventions">Clients    </span>
    
<button onClick={handlDelete} className="Main-butto-agent">Ajouter un client
</button>
          </div>
